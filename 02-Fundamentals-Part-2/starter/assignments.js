...
const descriptionCountry = describeCountry("Finland", 6, "Helsinki");
...
const populations = [130, 245, 21, 43];
...
const index = neighbours.indexOf('Mexico');
neighbours[index] = 'Republic of Mexico';
